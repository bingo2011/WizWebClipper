...
var specialLocation = {
	'My Notes' : com_wizbrother_Message.get('MyNotes'),
	'My Mobiles' : com_wizbrother_Message.get('MyMobiles'),
	'My Drafts' : com_wizbrother_Message.get('MyDrafts'),
	'My Journals' : com_wizbrother_Message.get('MyJournals'),
	'My Events' : com_wizbrother_Message.get('MyEvents'),
	'My Contacts' : com_wizbrother_Message.get('MyContacts'),
	'My Tasks' : com_wizbrother_Message.get('MyTasks'),
	'Deleted Items' : com_wizbrother_Message.get('DeletedItems'),
	'My Sticky Notes' : com_wizbrother_Message.get('MyStickyNotes'),
	'Inbox' : com_wizbrother_Message.get('Inbox'),
	'Completed' : com_wizbrother_Message.get('Completed'),
	'My Photos' : com_wizbrother_Message.get('MyPhotos'),
	'My Emails' : com_wizbrother_Message.get('MyEmails')
}
/**
 * 对特殊的文件夹处理，返回相应的显示名
 */
