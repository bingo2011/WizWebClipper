function com_wizbrother_PageInfo() {
	//"use strict";
	...
	function findArticle() {
		...
		if (!hasCheckedArticle) {
			...
			if (!article) {
				var ex = new com_wizbrother_ExtractContentJS.LayeredExtractor();
...
Object.preventExtensions(com_wizbrother_PageInfo);

var wiz_pageInfo = new com_wizbrother_PageInfo();
